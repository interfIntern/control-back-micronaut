...
@MicronautTest
@Slf4j
class FoliosControllerTest {

    private static final String API_URI = "/folios";
    ...
    void testUpdate() {
        ...
        Folios response = client.toBlocking().retrieve(request, Folios.class);
        log.info("Respuesta {}", response);
        assertEquals(idPrueba, response.getIdFolio());
